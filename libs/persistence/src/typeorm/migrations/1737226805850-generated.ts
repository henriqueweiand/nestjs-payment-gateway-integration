...
export class Generated1737226805850 implements MigrationInterface {
    name = 'Generated1737226805850'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."payment_log_payment_status_enum" AS ENUM('PENDING', 'COMPLETED_SUCCESSFULLY', 'FAILED')`);
        await queryRunner.query(`CREATE TYPE "public"."payment_log_payment_type_enum" AS ENUM('CARD', 'VOUCHER')`);
        await queryRunner.query(`CREATE TABLE "payment_log" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "checkout_id" uuid NOT NULL, "payment_request" jsonb NOT NULL, "payment_response" jsonb, "payment_status" "public"."payment_log_payment_status_enum" NOT NULL, "payment_type" "public"."payment_log_payment_type_enum" NOT NULL, "payment_end_dtm" TIMESTAMP WITH TIME ZONE, "create_dtm" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "modify_dtm" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "amount" bigint DEFAULT '0', CONSTRAINT "PK_1b679dd9b2a5aec836097f7e6d6" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."checkout_payment_status_enum" AS ENUM('INITIALIZED', 'COMPLETED', 'FAILED_PAYMENT', 'FAILED_CHECKOUT')`);
